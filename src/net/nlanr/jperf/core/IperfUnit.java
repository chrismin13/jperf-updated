...
public enum IperfUnit {
	ADAPTIVE_BITS("a", "Adaptive Bits"), ADAPTIVE_BYTES("A", "Adaptive Bytes"), BITS("b", "Bits"), BYTES("B", "Bytes"),
	KBITS("k", "KBits"), KBYTES("K", "KBytes"), MBITS("m", "MBits"), MBYTES("M", "MBytes"), GBITS("g", "GBits"),
	GBYTES("G", "GBytes");
	...
	public static IperfUnit[] getAllowedOutputFormatUnits() {
		return new IperfUnit[] { ADAPTIVE_BITS, ADAPTIVE_BYTES, BITS, BYTES, KBITS, KBYTES, MBITS, MBYTES, GBITS,
				GBYTES };
	}
